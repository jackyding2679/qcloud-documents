...
| 参数 | 参数描述            |  类型         | 必填  |
| ---- | --------------------| --------------| ------|
| req  | GetBucket操作的请求 | GetBucketReq  | 是    |
| resp | GetBucket操作的响应 | GetBucketResp | 是    |
...
| 参数 | 参数描述            |  类型                                    | 必填  |
| ---- | --------------------| -----------------------------------------| ------|
| req  | PutObject操作的请求 | PutObjectByStreamReq/PutObjectByFileReq  | 是    |
| resp | PutObject操作的响应 | PutObjectByStreamResp/PutObjectByFileResp| 是    |
...
| 参数 | 参数描述             |  类型         | 必填  |
| ---- | ---------------------| --------------| ------|
| req  | HeadObject操作的请求 | HeadObjectReq | 是    |
| resp | HeadObject操作的响应 | HeadObjectResp| 是    |
...
| 参数 | 参数描述            |  类型                                                        | 必填  |
| ---- | --------------------| -------------------------------------------------------------| ------|
| req  | GetObject操作的请求 | GetObjectByFileReq/GetObjectByStreamReq/MultiGetObjectReq    | 是    |
| resp | GetObject操作的响应 | GetObjectByFileResp/GetObjectByStreamResp/MultiGetObjectResp | 是    |
...
| 参数 | 参数描述                |  类型             | 必填  |
| ---- | ------------------------| ------------------| ------|
| req  | PutObjectCopy操作的请求 | PutObjectCopyReq  | 是    |
| resp | PutObjectCopy操作的响应 | PutObjectCopyResp | 是    |
...
| 参数 | 参数描述               |  类型             | 必填  |
| ---- | -------------------- --| ------------------| ------|
| req  | DeleteObject操作的请求 | DeleteObjectReq   | 是    |
| resp | DeleteObject操作的响应 | DeletObjectResp   | 是    |
...
| 参数 | 参数描述                |  类型             | 必填  |
| ---- | ------------------------| ------------------| ------|
| req  | DeleteObjects操作的请求 | DeleteObjectsReq  | 是    |
| resp | DeleteObjects操作的响应 | DeletObjectsResp  | 是    |
...
| 参数 | 参数描述                    |  类型                | 必填  |
| ---- | ----------------------------| ---------------------| ------|
| req  | PostObjectRestore操作的请求 | PostObjectRestoreReq | 是    |
| resp | PostObjectRestore操作的响应 | PostObjectRestoreResp| 是    |
...
| 参数 | 参数描述                      |  类型                  | 必填  |
| ---- | ------------------------------| -----------------------| ------|
| req  | ListMultipartUpload操作的请求 | ListMultipartUploadReq | 是    |
| resp | ListMultipartUpload操作的响应 | ListMultipartUploadResp| 是    |
...
| 参数 | 参数描述                  |  类型              | 必填  |
| ---- | --------------------------| -------------------| ------|
| req  | InitMultiUpload操作的请求 | InitMultiUploadReq | 是    |
| resp | InitMultiUpload操作的响应 | InitMultiUploadResp | 是    |
...
| 参数 | 参数描述                 |  类型             | 必填  |
| ---- | -------------------------| ------------------| ------|
| req  | UploadPartData操作的请求 | UploadPartDataReq | 是    |
| resp | UploadPartData操作的响应 | UploadPartDataResp| 是    |
...
| 参数 | 参数描述                     |  类型                 | 必填  |
| ---- | -----------------------------| ----------------------| ------|
| req  | UploadPartCopyData操作的请求 | UploadPartCopyDataReq | 是    |
| resp | UploadPartCopyData操作的响应 | UploadPartCopyDataResp| 是    |
...
| 参数 | 参数描述            |  类型        | 必填  |
| ---- | --------------------| -------------| ------|
| req  | ListParts操作的请求 | ListPartsReq | 是    |
| resp | ListParts操作的响应 | ListPartsResp| 是    |
...
| 参数 | 参数描述                     |  类型                  | 必填  |
| ---- | -----------------------------|------------------------| ------|
| req  | CompleteMultiUpload操作的请求 | CompleteMultiUploadReq | 是    |
| resp | CompleteMultiUpload操作的响应 | CompleteMultiUploadResp| 是    |
...
| 参数 | 参数描述                   |  类型                | 必填  |
| ---- | ---------------------------|----------------------| ------|
| req  | AbortMultiUpload操作的请求 | AbortMultiUploadReq  | 是    |
| resp | AbortMultiUpload操作的响应 | AbortMultiUploadResp | 是    |
...
| 参数 | 参数描述                    |  类型                 | 必填  |
| ---- | ----------------------------|-----------------------| ------|
| req  | MultiUploadObject操作的请求 | MultiUploadObjectReq  | 是    |
| resp | MultiUploadObject操作的响应 | MultiUploadObjectResp | 是    |
...
| 参数 | 参数描述                 |  类型              | 必填  |
| ---- | -------------------------|--------------------| ------|
| req  | MultiGetObject操作的请求 | MultiGetObjectReq  | 是    |
| resp | MultiGetObject操作的响应 | MultiGetObjectResp | 是    |
