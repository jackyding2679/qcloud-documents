...
| 参数 | 参数描述                                  |
| ---- | ----------------------------------------- |
| req  | PutBucketInventoryReq，PutBucketInventory 操作的请求  |
| resp | PutBucketInventoryResp，PutBucketInventory 操作的响应 |
...
| 参数 | 参数描述                                  |
| ---- | ----------------------------------------- |
| req  | GetBucketInventoryReq，GetBucketInventory 操作的请求  |
| resp | GetBucketInventoryResp，GettBucketInventory 操作的响应 |
...
| 参数 | 参数描述                                  |
| ---- | ----------------------------------------- |
| req  | ListBucketInventoryConfigurationsReq，ListBucketInventoryConfigurations操作的请求  |
| resp | ListBucketInventoryConfigurationsResp，ListBucketInventoryConfigurations操作的响应 |
...
| 参数 | 参数描述                                  |
| ---- | ----------------------------------------- |
| req  | DeleteBucketInventoryReq，DeleteBucketInventory操作的请求  |
| resp | DeleteBucketInventoryResp，DeleteBucketInventory操作的响应 |
