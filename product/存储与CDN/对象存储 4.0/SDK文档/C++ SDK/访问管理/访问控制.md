...
// 设置ACL配置(可以通过Body、Header两种方式，但只能二选一，否则会有冲突)
// 1.通过header设置ACL
...
| 参数 | 参数描述                | 类型            | 必填  |
| ---- | ------------------------| ----------------| ------|
| req  | PutBucketACL操作的请求  | PutBucketACLReq | 是    |
| resp | PutBucketACL操作的响应  | PutBucketACLResp| 是    |
...
struct Owner {
    // 存储桶持有者信息
    std::string m_id; // owner的完整ID，格式为：qcs::cam::uin/<OwnerUin>:uin/<SubUin>
    std::string m_display_name;  // owner的描述
};
...
| 参数 | 参数描述                | 类型            | 必填  |
| ---- | ------------------------| ----------------| ------|
| req  | GetBucketACL操作的请求  | GetBucketACLReq | 是    |
| resp | GetBucketACL操作的响应  | GetBucketACLResp| 是    |
...
| 参数 | 参数描述                | 类型             | 必填  |
| ---- | ------------------------| -----------------| ------|
| req  | PutObjectACL操作的请求  | PuttObjectACLReq | 是    |
| resp | PutObjectACL操作的响应  | PutObjectACLResp | 是    |
...
| 参数 | 参数描述                | 类型            | 必填  |
| ---- | ------------------------| ----------------| ------|
| req  | GetObjectACL操作的请求  | GetObjectACLReq | 是    |
| resp | GetObjectACL操作的响应  | GetObjectACLResp| 是    |
