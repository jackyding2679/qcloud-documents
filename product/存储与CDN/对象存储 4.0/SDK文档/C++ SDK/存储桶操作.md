...
| 参数 | 参数描述             | 类型          | 必填  |
| ---- | ---------------------|---------------| ------|
| req  | GetService操作的请求 | GetServiceReq | 是    |
| resp | GetService操作的响应 | GetServiceResp| 是    |
...
| 参数 | 参数描述            | 类型         | 必填  |
| ---- | --------------------|--------------| ------|
| req  | PutBucket操作的请求 | PutBucketReq | 是    |
| resp | PutBucket操作的响应 | PutBucketResp| 是    |
...
| 参数 | 参数描述             |  类型         | 必填  |
| ---- | ---------------------| --------------| ------|
| req  | HeadBucket操作的请求 | HeadBucketReq | 是    |
| resp | HeadBucket操作的响应 | HeadBucketResp| 是    |
...
| 参数 | 参数描述               |  类型           | 必填  |
| ---- | -----------------------| ----------------| ------|
| req  | DeleteBucket操作的请求 | DeleteBucketReq | 是    |
| resp | DeleteBucket操作的响应 | DeleteBucketResp| 是    |
